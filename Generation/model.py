...
from Common.loss_utils import compute_all_metrics2,AverageValueMeter,dist_simple
...
class Model(object):
    ...
    def sphere_generator(self,bs=2,static=True, ori_teeth=True):

        if ori_teeth is True:
